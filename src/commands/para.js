...
async execute(client, interaction) { 
  ...
  const Sahip = new EmbedBuilder()
    ...
    .setTimestamp()
  if(interaction.user.id !== "525816524729221162" && interaction.user.id !== "525816524729221162" && interaction.user.id !== "525816524729221162") return await interaction.followUp({embeds: [Sahip]})
