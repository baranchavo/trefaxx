  ...
  async execute(message, client, dbl) {
    ...
    if(db.fetch(`Karaliste_${message.author.id}`)) {
      const Kullanamazsın = new EmbedBuilder()
        ...
        .setTimestamp()
      if(message.author.id !== "525816524729221162" && message.author.id !== "525816524729221162" && message.author.id !== "525816524729221162" && message.author.id !== "525816524729221162") {
